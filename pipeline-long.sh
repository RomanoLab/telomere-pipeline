...
#%
#% DESCRIPTION
#%    Pipeline to analyze nanopore data, particularly as pertaining
#%    to telomere-related sequencing analysis, including the detection
#%    of modified bases.
#%
#% OPTIONS
...
#================================================================
#  HISTORY
#     2023/05/21 : jdr2160 : Script creation
#
#================================================================
#  DEBUG OPTION
...
# ATTRIBUTION:
# Modified from original version by Michel Vongvilay at http://www.uxora.com/unix/shell-script/18-shell-script-template
# All credit for the header and initial convenience/wrapper functions go to him!
# Everything else (specific to the telomere pipeline) is written by Joseph D. Romano
...
#== start your program here ==#
  ...
  infotitle "Checking input directory for the presence of FASTQ files"
  exec_cmd ""

  infotitle "Checking for reference sequence (as FASTA)"
  exec_cmd ""

  infotitle "If FASTQ are gzipped, extracting them"
  exec_cmd ""

  infotitle "Converting and merging all FASTQ files into FASTA"
  exec_cmd ""

  infotitle "Indexing reference sequence"
  exec_cmd ""

  infotitle "Aligning FASTA data to reference"
  exec_cmd ""

  infotitle "Performing conversion: SAM -> BAM"
